...
ALTER TABLE "public"."kkj_project_person" DROP CONSTRAINT "fkey_person_project";
...
ALTER TABLE "public"."kkj_project_person" ADD CONSTRAINT "fkey_person_project" FOREIGN KEY ("person_id") REFERENCES "public"."kkj_person" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
